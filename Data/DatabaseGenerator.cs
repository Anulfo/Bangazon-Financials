...
namespace Bangazon_Financials
{
    public class DatabaseGenerator
    {
        ...
        string[] customersName = new[] { "Carys", "Emmett", "Latoya", "Trina", "Kade", "Torin", "Aggie", "Caelan", "Patsy", "Bettina", "Hans", "Leda", "Clair", "Evan", "Roscoe", "Sondra", "Dixon", "Gail" };
        ...
        string[] productName = new[] { "Rug", "Wine Glasses", "Book Ends", "Picture Frame", "Blu-Ray Player", "Digital Camera", "Stuffed Animal - Monkey", "Stuffed Animal - Sloth", "Spatula", "Crayons", "Headphones", "Lawn Furniture", "Hammer", "Computer Monitor", "Golf Clubs", "Raspberry Pi", "eReader" };
        ...
        public string RandomizeCustomerProducts()
        {
            ...
            var rnd3 = rnd.Next(productName.Length);
            ...
            var rnd7 = rnd.Next(productSupplierState.Length);
